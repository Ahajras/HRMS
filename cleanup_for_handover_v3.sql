...
FROM employee e
WHERE e.id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid
...
WHERE a.employee_id = e.id
  AND e.id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid
  AND p.code = 'DEMO'
...
WHERE employee_id = (SELECT id FROM employee WHERE id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid)
  AND supervisor_employee_id IN (SELECT id FROM employee WHERE id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid);

UPDATE employee SET supervisor_employee_id = NULL, timekeeper_employee_id = NULL
WHERE id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;
...
WHERE tdc.timesheet_day_id = td.id AND td.timesheet_id = t.id
  AND t.employee_id = e.id AND e.id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM timesheet_day td
USING timesheet t, employee e
WHERE td.timesheet_id = t.id AND t.employee_id = e.id AND e.id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM payroll_adjustment pa
USING employee e
WHERE pa.employee_id = e.id AND e.id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM leave_adjustment la
USING employee e
WHERE la.employee_id = e.id AND e.id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM leave_request lr
USING employee e
WHERE lr.employee_id = e.id AND e.id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM timesheet t
USING employee e
WHERE t.employee_id = e.id AND e.id = 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;
...
WHERE a.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;
...
WHERE au.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM crew_member cm USING employee e
WHERE cm.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM employee_bank_account eb USING employee e
WHERE eb.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM employee_dependent ed USING employee e
WHERE ed.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM employee_document edoc USING employee e
WHERE edoc.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM employee_shift es USING employee e
WHERE es.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM timekeeper_project tp USING employee e
WHERE tp.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM legacy_employee_raw ler USING employee e
WHERE ler.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM contract_pay_item cpi USING employee e
WHERE cpi.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;

DELETE FROM contract c USING employee e
WHERE c.employee_id = e.id AND e.id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;
...
DELETE FROM employee WHERE id <> 'efe2f49c-1f5e-4ce8-a004-9275da55af1a'::uuid;
