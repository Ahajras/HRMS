...
const SIDEBAR_SKINS = [
  {
    key: "blue",
    label: "Blue",
    background: "linear-gradient(180deg, #dbeafe 0%, #eff6ff 44%, #bfdbfe 100%)",
    surface: "#dbeafe",
    selected: "#2563eb",
  ...
  },
  {
    key: "purple",
    label: "Purple",
    background: "linear-gradient(180deg, #ede9fe 0%, #f5f3ff 44%, #ddd6fe 100%)",
    surface: "#ede9fe",
    selected: "#7c3aed",
  ...
  },
  {
    key: "teal",
    label: "Teal",
    background: "linear-gradient(180deg, #ccfbf1 0%, #f0fdfa 44%, #99f6e4 100%)",
    surface: "#ccfbf1",
    selected: "#0f766e",
  ...
  },
  {
    key: "graphite",
    label: "Graphite",
    background: "linear-gradient(180deg, #e4e4e7 0%, #f4f4f5 44%, #d4d4d8 100%)",
    surface: "#e4e4e7",
    selected: "#52525b",
